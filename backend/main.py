...
ROADS = [
    ...
    },
    {
        ...
        "lanes": [
            ...
            {"id": 2, "name": "Полоса 2", "direction": "На Москву",          "condition": "Плохое",             "last_paved": "2018-09-14"},
            {"id": 3, "name": "Полоса 3", "direction": "На Санкт-Петербург", "condition": "Удовлетворительное", "last_paved": "2021-06-30"},
            {"id": 4, "name": "Полоса 4", "direction": "На Санкт-Петербург", "condition": "Хорошее",            "last_paved": "2023-03-15"},
        ],
        "weather_suitable": True,
    ...
    },
    {
        ...
        "lanes": [
            ...
            {"id": 2, "name": "Полоса 2", "direction": "На Москву",          "condition": "Плохое",             "last_paved": "2020-11-05"},
            {"id": 3, "name": "Полоса 3", "direction": "На Санкт-Петербург", "condition": "Хорошее",            "last_paved": "2024-03-20"},
            {"id": 4, "name": "Полоса 4", "direction": "На Санкт-Петербург", "condition": "Хорошее",            "last_paved": "2023-09-15"},
        ],
        "weather_suitable": True,
