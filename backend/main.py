...
FACTORIES = [
    {
        "id": 1,
        "slug": "vysokovsky_avtodor_abz",
        "name": "ГУП МО Высоковский Автодор, АБЗ",
        "coords": [56.317063, 36.566274],
        "vehicle_count": 2,
        "vehicles": _VEHICLES_F1,
        "mix_temp_c": 160,
        "active": True,
        "capacity_t_per_hour": 160.0,
        "materials": ["Асфальтобетон горячий тип А", "Битум БНД 60/90", "Щебень фр. 5-20"],
    },
    {
        "id": 2,
        "slug": "sk_megalit_spb_astec",
        "name": "СК Мегалит, АБЗ ASTEC",
        "coords": [59.815405, 30.463587],
        "vehicle_count": 0,
        "vehicles": [],
        "mix_temp_c": 160,
        "active": True,
        "capacity_t_per_hour": 360.0,
        "materials": ["Асфальтобетон горячий тип Б", "Щебеночно-мастичный асфальт СМА-16"],
    },
    {
        "id": 3,
        "slug": "abz_magistral_spb",
        "name": "АБЗ Магистраль, Санкт-Петербург",
        "coords": [59.928181, 30.440303],
        "vehicle_count": 1,
        "vehicles": _VEHICLES_F3,
        "mix_temp_c": 160,
        "active": True,
        "capacity_t_per_hour": 240.0,
