...
export default function LeftPanel({ dark, onToggleDark, roads, parkings, onSelectRoad, onSelectParking, onSelectVehicleType, onShowLanes, vehicleCounts = {}, activeRoadId }) {
