...
export default function LeftPanel({ dark, onToggleDark, roads, parkings, factories, onSelectRoad, onSelectParking, onSelectFactory, onSelectVehicleType, onShowLanes, onShowTasks, vehicleCounts = {}, taskCount = 0, activeRoadId }) {
